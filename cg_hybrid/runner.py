...
params['matrix'] = "cfd2"
params['users'] = ["Fangzhou Ye", "Shihao Zhang"]

# Description du code exécuté
params['software'] = """MPI+OpenMP"""

# Description du matériel utilisé pour l'exécution
params['nodes'] = 4   # nombre de noeuds
params['cores'] = 6   # nombre total de coeurs
params['hardware'] = """Macbook Pro 2018"""
...
command_line = "mpirun -n {nodes} ./cg_hybrid --matrix ../mat/{matrix}.mtx --seed {seed}"
